...
#  Modify email and  Paths
  @[SUC:01-01] @UAT_TCS-01.01.4 @MRA-indv-only @main @MRA-IND-TAXTYPE
  Scenario Outline: UAT_TCS 01.01.4: To verify the process of Registering an individual successfully with mandatory fields
    ...
    And enters attachment details "Passport"  with number "00000007" and path "C:\id_doc.png"
...
#      | ContactTypeValue         | Email                                                                   | 34 13 |
#      | ContactDetails           | margiewambui11@gmail.com                                                | 35 14 |
#    And enters attachment details "Business Registration Certificate"  with number "000ff00007" and path "C:\id_doc.png"
...
#    And enters attachment details "Passport"  with number "00000ff007" and path "C:\id_doc.png"
#    Then Click On Individual Page Submit Button
#    And  Verify the ARN number "<ARN>"
#    Given Open CRM URL Module
#    And Close Popup Window
